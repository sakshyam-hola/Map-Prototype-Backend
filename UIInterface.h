...
// ─────────────────────────────────────────────────────────────────────────────
//  ConsoleUI — fully-functional terminal implementation.
//  Use as the default until the custom UI is ready.
// ─────────────────────────────────────────────────────────────────────────────
...
public:
    ...
    void displayPath(const PathResult& r, const Graph& graph) override;
...
private:
    void banner()   const;
    void separator(char c = '-', int n = 64) const;
    void printPathVisual(const PathResult& r, const Graph& g) const;

    int  readInt(int lo, int hi) const;
};
